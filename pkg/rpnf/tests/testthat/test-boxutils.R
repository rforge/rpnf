...
testthat::test_that(desc="Test, if nextBox() produces appropriate values",
{
  ...
  lower <- box2lower(boxnumber=boxnumber,boxsize=boxsize,log=log)
  upper <- box2upper(boxnumber=boxnumber,boxsize=boxsize,log=log)
  testthat::expect_equal(object=nextBox(quote=tst,status="X",boxsize=boxsize,log=log,offset=0),expected=upper)
  testthat::expect_equal(object=nextBox(quote=tst,status="O",boxsize=boxsize,log=log,offset=0),expected=lower)
...
testthat::test_that(desc="Test, if nextBox() produces appropriate values",
{
  testthat::expect_equal(object=nextBox(quote=46.0,status="X",boxsize=1L,log=F),expected=47)
  testthat::expect_equal(object=nextBox(quote=46.0000001,status="X",boxsize=1L,log=F),expected=47)
  testthat::expect_equal(object=nextBox(quote=46.9999999,status="X",boxsize=1L,log=F),expected=47)
  testthat::expect_equal(object=nextBox(quote=47.0,status="X",boxsize=1L,log=F),expected=48)

  testthat::expect_equal(object=nextBox(quote=46.0,status="O",boxsize=1L,log=F),expected=46)
  testthat::expect_equal(object=nextBox(quote=46.0000001,status="O",boxsize=1L,log=F),expected=46)
  testthat::expect_equal(object=nextBox(quote=46.9999999,status="O",boxsize=1L,log=F),expected=46)
  testthat::expect_equal(object=nextBox(quote=47.0,status="O",boxsize=1L,log=F),expected=47)
})
...
testthat::test_that(desc="Test, if nextBox() produces appropriate values",
{
  testthat::expect_equal(object=nextReversal(45.99999,"X",boxsize=1),expected=43)
  testthat::expect_equal(object=nextReversal(46.0,"X",boxsize=1),expected=44)
  testthat::expect_equal(object=nextReversal(46.00001,"X",boxsize=1),expected=44)
  testthat::expect_equal(object=nextReversal(45.99999,"O",boxsize=1),expected=48)
  testthat::expect_equal(object=nextReversal(46.0,"O",boxsize=1),expected=49)
  testthat::expect_equal(object=nextReversal(46.00001,"O",boxsize=1),expected=49)

  # check another boxsize
  testthat::expect_equal(object=nextReversal(45.99999,"X",boxsize=0.5),expected=44.5)
  testthat::expect_equal(object=nextReversal(46.0,"X",boxsize=0.5),expected=45)
  testthat::expect_equal(object=nextReversal(46.00001,"X",boxsize=0.5),expected=45)
  testthat::expect_equal(object=nextReversal(45.99999,"O",boxsize=0.5),expected=47)
  testthat::expect_equal(object=nextReversal(46.0,"O",boxsize=0.5),expected=47.5)
  testthat::expect_equal(object=nextReversal(46.00001,"O",boxsize=0.5),expected=47.5)

  # check another reversal number
  testthat::expect_equal(object=nextReversal(45.99999,"X",reversal=1,boxsize=1),expected=45)
  testthat::expect_equal(object=nextReversal(46.0,"X",reversal=1,boxsize=1),expected=46)
  testthat::expect_equal(object=nextReversal(46.00001,"X",reversal=1,boxsize=1),expected=46)
  testthat::expect_equal(object=nextReversal(45.99999,"O",reversal=1,boxsize=1),expected=46)
  testthat::expect_equal(object=nextReversal(46.0,"O",reversal=1,boxsize=1),expected=47)
  testthat::expect_equal(object=nextReversal(46.00001,"O",reversal=1,boxsize=1),expected=47)
